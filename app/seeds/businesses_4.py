...
Business(
    owner_id=22,
    category_id=3,
    address='5601 Butler St',
    city='Pittsburgh',
    state='PA',
    zip_code='15201',
    name='Paws in the Sand Pet Sitting',
    description='Providing reliable pet sitting and dog walking services throughout Pittsburgh.',
    website='https://pawsinthesand.com/',
    phone='4124501234',
    set_hours="yes",
    mon_open='0700',
    mon_close='1900',
...
Business(
    owner_id=30,
    category_id=8,
    address='214 Shady Ave',
    city='Pittsburgh',
    state='PA',
    zip_code='15206',
    name='Pittsburgh Pet Hospice',
    description='Providing compassionate end-of-life care and support for pets and their families.',
    website='https://www.pghpethospice.com/',
    phone='4129909225',
    set_hours="yes",
    mon_open='0900',
    mon_close='1700',
